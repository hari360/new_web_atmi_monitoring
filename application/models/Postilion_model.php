...
class Postilion_model extends CI_Model {
    ...
    function get_detail_summary_crm(){
        $this->db->select('*');
        $this->db->from('iso_get_summary_trx_crm');
    ...
    function get_detail_summary_crm_bank($batch_nr){
        ...
        $this->db->from('iso_get_summary_issuer_crm');
        $this->db->where('issuer_name !=', NULL); 
    ...
    function get_summary_query_trx($datefrom, $dateto, $batch_nr, $tran_type,$sink_node_name,$pan,$rrn,$prefix_term,$terminal_id,$response_code,$show_records){
    ...
    function get_real_transactions($datefrom, $dateto, $batch_nr, $tran_type,$sink_node_name,$pan,$rrn,$prefix_term,$terminal_id,$response_code,$show_records){
        ...
        $query = $this->db->query("exec iso_get_query_transactions ?,?,?,?,?,?,?,?,?,?,?", $params);
