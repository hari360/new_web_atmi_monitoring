...
class Verifyemail extends CI_Controller
{
  ...
  function verification(){
    ...
    $user_reg = $this->Accounts_model->get_user_id($this->uri->segment(4));
      ...
      $this->Accounts_model->update_data_verify_email($data,$user_reg->user_name,$this->uri->segment(4));
      ...
      $this->Accounts_model->insert_permission_page($data_insert);
